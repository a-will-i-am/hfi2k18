...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
      <h1 class="green-text"> How to apply </h1>
        <p class="black-text"> The Hightower foundation is committed to The enrichment of Jones high school students,
               the students of Florida Agricultural & Mechanical Unversity EET program, and the youth in our
               own families and the families of loved ones. We are passionate about our youth and their educational
               careers.
        </p>
        <a class="waves-effect waves-light btn amber">Coming Soon</a>
       </div>
       <br>
       <br>
       <br>
                ...
                <div class="row">
                  ...
                  <div class="col l4 offset-l2 s12">
                    ...
                    <ul>
                      ...
                      <li><a href="#focus" class="white-text">Focus</a></li>
                      <li><a href="#donate" class="white-text">Donate</a></li>
                      <li><a href="#apply" class="white-text">Apply</a></li>
